...
class AvtaleService(
    ...
    suspend fun hentAvtale(orgnr: String, fnr: String, tjeneste: Avgiver.Tjeneste): Avtale {
    ...
    suspend fun opprettAvtale(avtale: AvtaleRequest, fnrInnsender: String): Avtale {
        ...
        val avtale = hentAvtale(avtale.orgnr, fnrInnsender, Avgiver.Tjeneste.AVTALESIGNERING)
